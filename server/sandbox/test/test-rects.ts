...
import { createWorld, createSprite, fill, noFill, noStroke, stroke, rect, ellipse,
	...
	mouseIsOver, mousePressedOver, mouseWentDown, drawSprites, mouseWentUp,
	getKeyValue, setKeyValue, log, playSound, randomNumber, strokeWeight, mouseDown } from "../emulator/api.js";
